...
<head>
    ...
    <title> <?= $data['bloggconfig'][0]['title']?> - Nytt inlägg</title>
...
<div class="row container">
    <div class="large-10 medium-10 small-10 columns large-centered medium-centered small-centered">
        ...
        <form action="" method="post">
            ...
            <input type="text" id="header" name="header" value="<?= isset($_POST['header']) ? $_POST['header'] : ''; ?>" >
            <label for="body">Inlägg:</label>
            <textarea name="body" id="body"><?= isset($_POST['body']) ? $_POST['body'] : ''; ?></textarea>
            <input type="submit" name="blogg_post_submit" class="button large right" value="Publicera">
        </form>
    </div>
</div>
</body>
